...
9. **Duplicate or overlapping pages**. Flag pages that appear to cover the same concept, entity, or question from a structural reading of titles, links, and summaries. Suggest consolidation when appropriate.
